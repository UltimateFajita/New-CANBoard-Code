...
**************************************************************************/
	...
	OneTime[0].cdat[6] = 0;
	OneTime[0].cdat[7] = 0;
	AddMessage(0,0x22D,950,8,OneTime[0].cdat);  // SWS_8 - Steering Wheel messages
...
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	...
	OneTime[1].cdat[0] = 0xFF;		// values (ORed)
	OneTime[1].cdat[1] = 0;
	OneTime[1].cdat[2] = 0;
	OneTime[1].cdat[3] = 0;
	OneTime[1].cdat[4] = 0;
	OneTime[1].cdat[5] = 0;
	OneTime[1].cdat[6] = 0x80;
	OneTime[1].cdat[7] = 0;
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
...
/*
	...
	OneTime[1].cdat[7] = 0;
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	SimpleButtonConfig(3,0,0x4A3,OneTime[0].cdat,OneTime[1].cdat,1);
...
/*
	...
	OneTime[1].cdat[7] = 0;
//U8 SimpleButtonConfig(U8 button,U8 port,U32 ID,U8 mask[8],U8 value[8],count);
	SimpleButtonConfig(2,0,0x4A3,OneTime[0].cdat,OneTime[1].cdat,1);
